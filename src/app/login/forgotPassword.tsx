    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.bottomContainer}>
                ...
                <Input placeholder="Digite seu e-mail" containerStyle={[styles.inputContainer, { width: width * 0.75, marginBottom: height * 0.01}]} onChangeText={setEmail} />

                <TouchableOpacity onPress={() => router.push('/login/forgotPasswordTel')}>
                    <Text style={[styles.infoTelefone, { fontSize: width * 0.033, width: width * 0.75, marginBottom: height * 0.03}]}>Recuperar pelo telefone</Text>
                </TouchableOpacity>
