    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.bottomContainer}>
                ...
                <Text style={[styles.infoTitle, { fontSize: width * 0.045, width: width * 0.8, textAlign: 'center'}]}>Digite o código de 6 dígitos que enviamos para seu E-mail</Text>
                ...
                <TouchableOpacity onPress={() => router.push('/login/forgotPasswordTel')}>
                    <Text style={[styles.infoTelefone, { fontSize: width * 0.03, width: width * 0.75, marginBottom: height * 0.02}]}>Recuperar pelo telefone</Text>
                </TouchableOpacity>

                <Text style={[styles.info, { fontSize: width * 0.04, width: width * 0.75, marginBottom: height * 0.03}]}>Enviaremos as instruções para você alterar a senha no seu E-mail</Text>
